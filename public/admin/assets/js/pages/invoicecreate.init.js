...
function new_link() {
    ...
    var e = document.createElement("tr"),
        t =
            ...
            count +
            '</th><td class="text-start"><div class="mb-2"><select class="select3 form-control bg-light border-0" name="code_product[]" id="productName-' +
            count +
            '"></select></div></td><td><input class="form-control bg-light border-0 product-price" type="number" id="productRate-' +
            count +
            '" step="0.01" placeholder="$0.00"></td><td><div class="input-step"><button type="button" class="minus">–</button><input type="number" name="quantity_product[]" class="product-quantity" id="product-qty-' +
            count +
            '" value="0" readonly><button type="button" class="plus">+</button></div></td><td class="text-end"><div><input type="text" name="montant_product[]" class="form-control bg-light border-0" id="productPrice-' +
            count +
            '" value="0.00f" readonly /></div></td><td class="product-removal"><a class="btn btn-success">Delete</a></td></tr>'),
        t =
    ...
    Array.from(t).forEach(function (e) {
        new Choices(e, {
            placeholderValue: "Ceci est un espace réservé défini dans la configuration",
            searchPlaceholderValue: "Ceci est un espace réservé à la recherche",
        });
    }),
        isData(),
        remove(),
