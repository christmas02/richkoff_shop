            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tr>
                    <td align="left" valign="middle"  style="overflow:hidden;min-width:480px;max-width:600px;padding:0px 0px 0px 0px">
                        <a href="#" style="display:block;width:600px;height:88px" aria-hidden="true">
                            <img src="https://richkoff.com/assets/images_/commun/logo-bg-dark.png" width="600" height="88" title=""  alt="" border="0" style="display:block;width:600px;max-width:600px"class="CToWUd">
                        </a>
                    </td>
                </tr>
                <!-- -->
                ...
                <tr>
                    <td align="left" valign="top" style="direction:ltr;padding:0 24px 0 24px">
                        ...
                        <h3> Bonjour {{ $user['username']  }},  {{ $user['firstname']  }}.</h3>
                        <br>
                        <p>  Nous avons bien reçus votre commande, notre charger client vous contacteras
                            pour la livraison de votre produits.  </p>
                        </p>
                ...
                <tr>
                    <td align="left" valign="top"
                        ...
                        <p style="margin:0;padding:0;color:#606060;font-family:Roboto,Arial,Helvetica,sans-serif;font-size:12px;font-weight:400;line-height:18px">
                            Cette notification vous a été envoyée afin de confirmer votre demande. <br>
